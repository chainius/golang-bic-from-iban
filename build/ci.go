...
import (
	...
	"github.com/Skyhark-Projects/golang-bic-from-iban/internal/build"
)
...
var (
	...
	debExecutables = []debExecutable{
		...
		{
			Name:        "geth",
			Description: "DEX CLI client.",
		},
        {
			Name:        "router",
			Description: "DEX Router CLI client.",
		},
		{
			Name:        "puppeth",
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/Skyhark-Projects/golang-bic-from-iban/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/Skyhark-Projects/golang-bic-from-iban/mobile")
